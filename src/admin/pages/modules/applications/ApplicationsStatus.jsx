                ...
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        {mockOngoingApplications.map((app) => {
                            ...
                            return (
                                <tr key={app.id} className="border-b border-secondary-100 last:border-0 hover:bg-secondary-50 cursor-pointer" onClick={() => navigate(`/admin/applications/${app.id}`)}>
                                    ...
                                    <td className="p-3">
                                        <button onClick={(e) => { e.stopPropagation(); navigate(`/admin/applications/${app.id}`); }} className="p-1.5 text-secondary-500 hover:text-blue-600">
                                            <Eye size={16} />
                                        </button>
                                    </td>
                                </tr>
