...
const BrokerTenantDetail = () => {
    ...
    return (
        <div>
            <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-sm text-secondary-600 hover:text-green-600 mb-4">
                <ArrowLeft size={16} />
                Back to My Tenants
            </button>
            <DetailHeader
...
export default BrokerTenantDetail;
