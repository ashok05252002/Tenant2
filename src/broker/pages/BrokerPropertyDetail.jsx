...
const BrokerPropertyDetail = () => {
    ...
    const handleSave = (formData) => {
        console.log("Updating property (Broker):", formData);
        setIsEditing(false);
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <div>
                    <button onClick={() => navigate('/broker/properties')} className="flex items-center gap-2 text-sm text-secondary-600 hover:text-green-600 mb-2">
                        <ArrowLeft size={16} />
                        Back to My Listings
                    </button>
                ...
                <div className="flex gap-2">
                    {isEditing ? (
                        ...
                        <>
                            ...
                            <button onClick={() => setIsEditing(true)} className="flex items-center gap-2 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 font-medium text-sm">
