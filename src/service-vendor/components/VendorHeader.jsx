...
const VendorHeader = ({ onToggleSidebar, isSidebarCollapsed }) => {
    return (
            ...
            <div className="flex items-center">
                ...
                <div className="relative ml-4">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-secondary-100 border border-transparent rounded-lg focus:ring-2 focus:ring-orange-500 focus:bg-white"
                    />
                </div>
            </div>
